...
@interface CALayer (SWIFT_EXTENSION(FlatButton))
@end
...
SWIFT_CLASS("_TtC10FlatButton10FlatButton")
@interface FlatButton : NSButton <CALayerDelegate>
@property (nonatomic) BOOL momentary;
@property (nonatomic) double onAnimationDuration;
@property (nonatomic) double offAnimationDuration;
@property (nonatomic) CGFloat cornerRadius;
@property (nonatomic) CGFloat borderWidth;
@property (nonatomic, strong) NSColor * _Nonnull buttonColor;
@property (nonatomic, strong) NSColor * _Nonnull activeButtonColor;
@property (nonatomic, strong) NSColor * _Nonnull iconColor;
@property (nonatomic, strong) NSColor * _Nonnull activeIconColor;
...
@interface NSColor (SWIFT_EXTENSION(FlatButton))
@end
